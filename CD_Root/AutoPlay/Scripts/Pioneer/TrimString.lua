function Binesh.TrimString(sInput)
	if sInput ~= "" then
		...
		result = String.Replace(sInput, "ÊÚÏÇÏãæá", "ÊÚÏÇÏ ãæá", false);
		
		result = String.Replace(sInput, "ÑæÊæäí", "ÑæÊæä", false);
		result = String.Replace(sInput, "Çá˜ÊÑæäí", "Çá˜ÊÑæä", false);
		result = String.Replace(sInput, "äæÊÑæäí", "äæÊÑæä", false);
