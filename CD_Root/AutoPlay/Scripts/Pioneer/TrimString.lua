function Binesh.TrimString(sInput)
	if sInput ~= "" then
		...
		result = String.Replace(result, "ãÌĞæÑ", "ãÑÈÚ", false);
		...
		result = String.Replace(result, "Çåã ãÊÑ", "Çåã ÏÑ ãÊÑ", false);
		...
		result = String.Replace(result, "ÊÇÈÌÓã", "ÊÇÈÔ", false);
		result = String.Replace(result, "Ú ÏÓí", "ÚÏÓí", false);
		result = String.Replace(result, "ÇäÏÇÒå", "Øæá", false);
		result = String.Replace(result, "ÎÇÒäí", "ÎÇÒä", false);
