function Binesh.F112()
	if Ru1 == nil then
		Binesh.AddUnknown("«Ê·Ì‰ „ﬁ«Ê„  ÊÌéÂ", "Ru1")
	end
	
	if Ru2 == nil then
		Binesh.AddUnknown("œÊ„Ì‰ „ﬁ«Ê„  ÊÌéÂ", "Ru2")
	end
	
	if Alpha_112 == nil and Alpha_112_K == nil then
		Binesh.AddUnknown("÷—Ì» œ„«ÌÌ", "Alpha")
	end
	...
	if FindAlpha_112 ~= -1 and ListBox.GetItemData("unknowns", FindAlpha_112) == "Alpha" and ListBox.FindItem("Words", -1, LB_BYTEXT, "÷—Ì» œ„«ÌÌ „ﬁ«Ê„  ÊÌéÂ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "Alpha") ~= -1 then
