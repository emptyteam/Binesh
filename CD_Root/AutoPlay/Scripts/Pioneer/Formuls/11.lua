function Binesh.F11()
	if Sp == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, " ’ÊÌ— ”ÿÕ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "S`") ~= -1) then
	...
	if q_Source == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "›«’·Â „‰»⁄ ‰Ê—  ’ÊÌ—") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "q") ~= -1) then
