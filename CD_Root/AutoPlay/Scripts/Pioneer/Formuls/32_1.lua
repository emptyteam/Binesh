function Binesh.F32_1()
	if VBar_Speed_mh ~= nil  then
		...
		Binesh.CreateHTMLFile("VBar<sub>m/s</sub> = <span>VBar<sub>m/h</sub>/3.6</span>", "VBar<sub>m/s</sub> = <span>"..Binesh.Convert_e(VBar_Speed_mh).."/3.6</span>")
		Binesh.AddToHTML("VBar<sub>m/s</sub> = "..Binesh.Convert_e(VBar_Speed).."m/s");
	end
	
	if VBar_Speed_miles ~= nil then
		VBar_Speed = VBar_Speed_miles*1609.3
		Binesh.CreateHTMLFile("VBar<sub>m/s</sub> = VBar<sub>mile/s</sub>*1609.3", "VBar<sub>m/s</sub> = "..Binesh.Convert_e(VBar_Speed_miles).."*1609.3")
		Binesh.AddToHTML("VBar<sub>m/s></sub> = "..Binesh.Convert_e(VBar_Speed).."m/s");
	end
	
	if VBar_Speed_mileh ~= nil then
		VBar_Speed = VBar_Speed_mileh*1609.3/3.6
		Binesh.CreateHTMLFile("VBar<sub>m/s</sub> = VBar<sub>mile/h</sub>*<span>1609.3/3.6</span>", "VBar<sub>m/s</sub> = "..Binesh.Convert_e(VBar_Speed_miles).."*<span>1609.3/3.6</span>")
		Binesh.AddToHTML("VBar<sub>m/s></sub> = "..Binesh.Convert_e(VBar_Speed).."m/s");
	end
	...
	if _Deltax == nil then
		if _x1 ~= nil and _x2 ~= nil then
			...
			_Deltax = _x2 - _x1
			Binesh.AddToHTML("Deltax = "..Binesh.Convert_e(_x2).."-"..Binesh.Convert_e(_x1).." &#8658; Deltax = "..Binesh.Convert_e(_Deltax).." m")
		end
	end
	...
	if _x1 == nil then
		if _Deltax ~= nil and _x2 ~= nil then
			...
			_x1 = _x2-_Deltax
			Binesh.AddToHTML("x<sub>1</sub> = "..Binesh.Convert_e(_x2).."-"..Binesh.Convert_e(_Deltax).." &#8658; x<sub>1</sub> = "..Binesh.Convert_e(_x1).." m")
		end
	end
	...
	if _x2 == nil then
		if _Deltax ~= nil and _x1 ~= nil then
			...
			_x2 = _x1+_Deltax
			Binesh.AddToHTML("x<sub>2</sub> = "..Binesh.Convert_e(_Deltax).."+"..Binesh.Convert_e(_x1).." &#8658; x<sub>2</sub> = "..Binesh.Convert_e(_x2).." m")
		end
	end
	...
	if _Deltat == nil then
		if _t1 ~= nil and _t2 ~= nil then
			...
			_Deltat = _t2 - _t1
			Binesh.AddToHTML("Deltat = "..Binesh.Convert_e(_t2).."-"..Binesh.Convert_e(_t1).." &#8658; Deltat = "..Binesh.Convert_e(_Deltat).." s")
		end
	end
	...
	if _t1 == nil then
		if _Deltat ~= nil and _t2 ~= nil then
			...
			_t1 = _t2-_Deltat
			Binesh.AddToHTML("t<sub>1</sub> = "..Binesh.Convert_e(_t2).."-"..Binesh.Convert_e(_Deltat).." &#8658; t<sub>1</sub> = "..Binesh.Convert_e(_t1).." s")
		end
	end
	...
	if _t2 == nil then
		if _Deltat ~= nil and _t1 ~= nil then
			...
			_t2 = _t1+_Deltat
			Binesh.AddToHTML("t<sub>2</sub> = "..Binesh.Convert_e(_Deltat).."+"..Binesh.Convert_e(_t1).." &#8658; t<sub>2</sub> = "..Binesh.Convert_e(_t2).." s")
		end
	end
	--------------------------END {DELTA}--------------------------
	if VBar_Speed == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "”—⁄  „ Ê”ÿ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "VBar") ~= -1) then
		if _Deltax ~= nil and _Deltat ~= nil then
			...
			Binesh.AddToHTML("VBar = <span>"..Binesh.Convert_e(_Deltax).."/"..Binesh.Convert_e(_Deltat).."</span> &#8658; VBar = "..Binesh.Convert_e(VBar_Speed).." m/s")
	...
	if _Deltax == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, " €ÌÌ— ›«’·Â") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "›«’·Â  €ÌÌ—") ~= -1) or ListBox.FindItem("Words", -1, LB_BYTEXT, "Deltax") ~= -1) then
		if VBar_Speed ~= nil and _Deltat ~= nil then
			...
			Binesh.AddToHTML("Deltax = "..Binesh.Convert_e(VBar_Speed).."*"..Binesh.Convert_e(_Deltat).." &#8658; Deltax = "..Binesh.Convert_e(_Deltax).." m")
	...
	if _Deltat == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, " €ÌÌ— “„«‰") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "“„«‰  €ÌÌ—") ~= -1) or ListBox.FindItem("Words", -1, LB_BYTEXT, "Deltat") ~= -1) then
		if _Deltax ~= nil and VBar_Speed ~= nil then
			...
			Binesh.AddToHTML("Deltat = <span>"..Binesh.Convert_e(_Deltax).."/"..Binesh.Convert_e(VBar_Speed).."</span> &#8658; Deltat = "..Binesh.Convert_e(_Deltat).." s")
