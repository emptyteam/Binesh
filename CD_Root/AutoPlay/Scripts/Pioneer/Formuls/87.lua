...
elseif Findq_0_87 ~= -1 and ListBox.GetItemData("unknowns", Findq_0_87) == "q0" and ListBox.FindItem("Words", -1, LB_BYTEXT, "–—Â") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "q0") ~= -1 then
