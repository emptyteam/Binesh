	...
	if ListBox.FindItem("Words", -1, LB_BYTEXT, "«·ò —ÌòÌ") == -1 then
		...
		if t == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "“„«‰") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "t") ~= -1) then
			if A ~= nil and Fi ~= nil and Omega ~= nil and B ~= nil then
				...
				Binesh.AddToHTML("CosOmegat = <span>"..Binesh.ProgressNumber(Fi).."/"..Binesh.ProgressNumber(A).."*"..Binesh.ProgressNumber(B).."</span> &#8658; CosOmegat = "..Binesh.ProgressNumber(CosOmegat).."<br> &#8658; Omegat = Cos<sup>-1</sup>("..Binesh.ProgressNumber(CosOmegat)..") &#8658; Omegat = "..Binesh.ProgressNumber(Omegat).." &#8658; t = <span>"..Binesh.ProgressNumber(Omegat).."/"..Binesh.ProgressNumber(Omega).."</span> &#8658; t = "..Binesh.ProgressNumber(t).." s" )
