function Binesh.F128()
	if ListBox.FindItem("Words", -1, LB_BYTEXT, "Çá˜ÊÑí˜í") == -1 then
		if F == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "äíÑæ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "F") ~= -1) then
		...
		if Teta == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "ÒÇæíå") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "Teta") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "Alpha") ~= -1)) then
