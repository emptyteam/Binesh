function Binesh.F36()
	if t0 == nil or ListBox.GetItemData("unknowns", Findt0) == "t" and ListBox.FindItem("Words", -1, LB_BYTEXT, "“„«‰") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "t0") ~= -1 then
	...
	if V0_Speed == nil or ListBox.GetItemData("unknowns", FindV0_Speed) == "V" and ListBox.FindItem("Words", -1, LB_BYTEXT, "”—⁄ ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "V0") ~= -1 then
