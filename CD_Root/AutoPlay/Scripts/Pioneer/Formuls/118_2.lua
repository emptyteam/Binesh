function Binesh.F118_2()
	if RT == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "„ﬁ«Ê„  „⁄«œ·") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "RT") ~= -1) then
		if R1 ~= nil and V1_Electric ~= nil and VT_Electric ~= nil then
			...
			Binesh.AddToHTML("R<sub>T</sub> = "..Binesh.Convert_e(R1).."*"..Binesh.Convert_e(VT_Electric).."/"..Binesh.Convert_e(V1_Electric).." &#8658; R<sub>T</sub> = "..Binesh.Convert_e(RT).." Ohm")
			
			Binesh.AddToHTML("R<sub>1</sub>: "..Binesh.Convert_e(R1).." Ohm", "V")
			Binesh.AddToHTML("V<sub>T</sub>: "..Binesh.Convert_e(VT_Electric).." V", "V")
	...
	if R1 == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "«Ê·Ì‰ „ﬁ«Ê„ ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "„ﬁ«Ê„  «Ê·Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "R1") ~= -1)) then
		if RT ~= nil and V1_Electric ~= nil and VT_Electric ~= nil then
			...
			Binesh.AddToHTML("R<sub>1</sub> = <span>"..Binesh.Convert_e(V1_Electric).."*"..Binesh.Convert_e(RT).."/"..Binesh.Convert_e(VT_Electric).."</span> &#8658; R<sub>1</sub> = "..Binesh.Convert_e(R1).." Ohm")
			
			Binesh.AddToHTML("R<sub>T</sub>: "..Binesh.Convert_e(RT).." Ohm", "V")
			Binesh.AddToHTML("V<sub>T</sub>: "..Binesh.Convert_e(VT_Electric).." V", "V")
			Binesh.AddToHTML("V<sub>1</sub>: "..Binesh.Convert_e(V1_Electric).." v", "V")
	...
	if V1_Electric == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "«Ê·Ì‰ Ê· «é") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "Ê· «é «Ê·Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "V1") ~= -1)) then
		if RT ~= nil and R1 ~= nil and VT_Electric ~= nil then
			...
			Binesh.AddToHTML("V<sub>1</sub> = <span>"..Binesh.Convert_e(R1).."*"..Binesh.Convert_e(VT_Electric).."/"..Binesh.Convert_e(RT).."</span> &#8658; V<sub>1</sub> = "..Binesh.Convert_e(V1_Electric).." V")
	...
	if VT_Electric == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "Ê· «é „⁄«œ·") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "VT") ~= -1) then
		if RT ~= nil and R1 ~= nil and V1_Electric ~= nil then
			...
			Binesh.AddToHTML("V<sub>T</sub> = <span>"..Binesh.Convert_e(V1_Electric).."*"..Binesh.Convert_e(RT).."/"..Binesh.Convert_e(R1).."</span> &#8658; V<sub>T</sub> = "..Binesh.Convert_e(VT_Electric).." V")
			
			Binesh.AddToHTML("R<sub>T</sub>: "..Binesh.Convert_e(RT).." Ohm", "V")
			Binesh.AddToHTML("V<sub>T</sub>: "..Binesh.Convert_e(V1_Electric).." V", "V")
			Binesh.AddToHTML("R<sub>1</sub>: "..Binesh.Convert_e(R1).." v", "V")
