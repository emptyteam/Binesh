...
Findf_Hz = ListBox.FindItem("unknowns", -1, LB_BYTEXT, "›—ò«‰”");
if Findf_Hz ~= -1 and ListBox.GetItemData("unknowns", Findf_Hz) == "f" and ListBox.FindItem("Words", -1, LB_BYTEXT, "›—ò«‰”") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "f") ~= -1 then
	if Oemga ~= nil then
