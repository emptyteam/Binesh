function Binesh.F38_2()
	if _x1 == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "«Ê·Ì‰ ›«’·Â") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "›«’·Â «Ê·Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "x1") ~= -1)) then
		if V2_Speed ~= nil and _Deltat ~= nil and V1_Speed ~= nil and _x2 ~= nil then
			...
			Binesh.AddToHTML("x<sub>1</sub> = "..Binesh.Convert_e(_x2).."- <span>"..Binesh.Convert_e(V1_Speed).."+"..Binesh.Convert_e(V2_Speed).."/2</span>*"..Binesh.Convert_e(_Deltat).." &#8658; x<sub>1</sub> = "..Binesh.Convert_e(_x1).." m")
			
			Binesh.AddToHTML("x<sun>2</sub>: "..Binesh.Convert_e(_x2).." m", "V")
	...
	if _x2 == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "œÊ„Ì‰ ›«’·Â") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "›«’·Â œÊ„Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "x2") ~= -1)) then
		if V2_Speed ~= nil and _Deltat ~= nil and V1_Speed ~= nil and _x1 ~= nil then
			...
			Binesh.AddToHTML("x<sub>2</sub> = "..Binesh.Convert_e(_x1).."+ <span>"..Binesh.Convert_e(V1_Speed).."+"..Binesh.Convert_e(V2_Speed).."/2</span>*"..Binesh.Convert_e(_Deltat).." &#8658; x<sub>2</sub> = "..Binesh.Convert_e(_x2).." m")
			
			Binesh.AddToHTML("x<sun>1</sub>: "..Binesh.Convert_e(_x1).." m", "V")
			Binesh.AddToHTML("V<sub>1</sub>: "..Binesh.Convert_e(V1_Speed).." m/s", "V")
			Binesh.AddToHTML("V<sun>2</sub>: "..Binesh.Convert_e(V2_Speed).." m/s", "V")
			Binesh.AddToHTML("Deltat: "..Binesh.Convert_e(_Deltat).." s", "V")
