function Binesh.F61()
	if Fi == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "«Ê·Ì‰ ‰Ì—Ê") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "‰Ì—Ê «Ê·Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "F1") ~= -1)) then
		if F2 ~= nil and A1 ~= nil and A2 ~= nil then
			...
			Binesh.AddToHTML("F<sub>1</sub> = <span>"..Binesh.ProgressNumber(A1).."*"..Binesh.ProgressNumber(F2).."/"..Binesh.ProgressNumber(A2).."</span> &#8658; F<sub>1</sub> = "..Binesh.ProgressNumber(F1).." N")
			
			Binesh.AddToHTML("A<sub>1</sub> = "..Binesh.ProgressNumber(A1).." m<sup>2</sup>", "V")
			Binesh.AddToHTML("F<sub>2</sub> = "..Binesh.ProgressNumber(F2).." N", "V")
			Binesh.AddToHTML("A<sub>2</sub> = "..Binesh.ProgressNumber(A2).." m<sup>2</sup>", "V")
	...
	if F2 == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "œÊ„Ì‰ ‰Ì—Ê") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "‰Ì—Ê œÊ„Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "F2") ~= -1)) then
		if F1 ~= nil and A1 ~= nil and A2 ~= nil then
			...
			Binesh.AddToHTML("F<sub>2</sub> = <span>"..Binesh.ProgressNumber(A2).."*"..Binesh.ProgressNumber(F1).."/"..Binesh.ProgressNumber(A1).."</span> &#8658; F<sub>2</sub> = "..Binesh.ProgressNumber(F2).." N")
			
			Binesh.AddToHTML("A<sub>1</sub> = "..Binesh.ProgressNumber(A1).." m<sup>2</sup>", "V")
			Binesh.AddToHTML("F<sub>1</sub> = "..Binesh.ProgressNumber(F1).." N", "V")
			Binesh.AddToHTML("A<sub>2</sub> = "..Binesh.ProgressNumber(A2).." m<sup>2</sup>", "V")
	...
	if A1 == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "«Ê·Ì‰ ”ÿÕ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "”ÿÕ «Ê·Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "A1") ~= -1)) then
		if F1 ~= nil and F2 ~= nil and A2 ~= nil then
			...
			Binesh.AddToHTML("A<sub>1</sub> = <span>"..Binesh.ProgressNumber(F1).."*"..Binesh.ProgressNumber(A2).."/"..Binesh.ProgressNumber(F2).."</span> &#8658; A<sub>1</sub> = "..Binesh.ProgressNumber(A1).." m<sup>2</sup>")
	...
	if A2 == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "œÊ„Ì‰ ”ÿÕ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "”ÿÕ œÊ„Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "A2") ~= -1)) then
		if F1 ~= nil and F2 ~= nil and A2 ~= nil then
			...
			Binesh.AddToHTML("A<sub>2</sub> = <span>"..Binesh.ProgressNumber(F2).."*"..Binesh.ProgressNumber(A1).."/"..Binesh.ProgressNumber(F1).."<span> &#8658; A<sub>2</sub> = "..Binesh.ProgressNumber(A2).." m<sup>2</sup>")
