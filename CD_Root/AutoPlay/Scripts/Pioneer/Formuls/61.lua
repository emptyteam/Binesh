if F1 == nil then
	UnknownNamePersian = ListBox.FindItem("unknowns", -1, LB_BYTEXT, "«Ê·Ì‰ ‰Ì—Ê")
	if UnknownNamePersian == -1 and ListBox.GetItemData("unknowns", UnknownNamePersian) ~= 'F1' then
		ListBox.AddItem("unknowns", "«Ê·Ì‰ ‰Ì—Ê", "F1");
	end
end

if F2 == nil then
	UnknownNamePersian = ListBox.FindItem("unknowns", -1, LB_BYTEXT, "œÊ„Ì‰ ‰Ì—Ê")
	if UnknownNamePersian == -1 and ListBox.GetItemData("unknowns", UnknownNamePersian) ~= 'F2' then
		ListBox.AddItem("unknowns", "œÊ„Ì‰ ‰Ì—Ê", "F2");
	end
end

if A1 == nil then
	UnknownNamePersian = ListBox.FindItem("unknowns", -1, LB_BYTEXT, "«Ê·Ì‰ ”ÿÕ")
	if UnknownNamePersian == -1 and ListBox.GetItemData("unknowns", UnknownNamePersian) ~= 'A1' then
		ListBox.AddItem("unknowns", "«Ê·Ì‰ ”ÿÕ", "A1");
	end
end

if A2 == nil then
	UnknownNamePersian = ListBox.FindItem("unknowns", -1, LB_BYTEXT, "œÊ„Ì‰ ”ÿÕ")
	if UnknownNamePersian == -1 and ListBox.GetItemData("unknowns", UnknownNamePersian) ~= 'A2' then
		ListBox.AddItem("unknowns", "œÊ„Ì‰ ”ÿÕ", "A2");
	end
end
...
elseif FindF2 ~= -1 and ListBox.GetItemData("unknowns", FindF2) == "F2" and ListBox.FindItem("Words", -1, LB_BYTEXT, "œÊ„Ì‰ ‰Ì—Ê") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "F2") ~= -1 then
...
elseif FindA1 ~= -1 and ListBox.GetItemData("unknowns", FindA1) == "A1" and ListBox.FindItem("Words", -1, LB_BYTEXT, "«Ê·Ì‰ ”ÿÕ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "A1") ~= -1 then
...
elseif FindA2 ~= -1 and ListBox.GetItemData("unknowns", FindA2) == "A2" and ListBox.FindItem("Words", -1, LB_BYTEXT, "œÊ„Ì‰ ”ÿÕ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "A2") ~= -1 then
	if F1 ~= nil and F2 ~= nil and A2 ~= nil then
