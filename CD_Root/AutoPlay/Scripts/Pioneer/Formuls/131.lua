		...
		if ListBox.FindItem("Words", -1, LB_BYTEXT, "Çá˜ÊÑí˜í") == -1 then
			if B == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "ãíÏÇä") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "B") ~= -1) then
				if N_Ring ~= nil and R_Radius ~= nil and I ~= nil then
					Binesh.CreateHTMLFile("B = N<span>Mu<sub>0</sub>/2</span> * <span>I/R</span>")
			...
			if R_Radius == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "ÔÚÇÚ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "R") ~= -1) then
				if ListBox.GetItemText("Words", ListBox.FindItem("Words", -1, LB_BYTEXT, "R")) == "R" then
					if N_Ring ~= nil and B ~= nil and I ~= nil then
						Binesh.CreateHTMLFile("B = N<span>Mu<sub>0</sub>/2</span> * <span>I/R</span>", "R = <span>NMu<sub>0</sub>I/2B</span>")
			...
			if N_Ring == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "ÍáÞå") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "ÏæÑ") ~= -1) or ListBox.FindItem("Words", -1, LB_BYTEXT, "N") ~= -1) then
				if R_Radius ~= nil and B ~= nil and I ~= nil then
					Binesh.CreateHTMLFile("B = N<span>Mu<sub>0</sub>/2</span> * <span>I/R</span>", "N = <span>2BR/Mu<sub>0</sub>I</span>")
			...
			if I == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "ÌÑíÇä") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "I") ~= -1) then
				if N_Ring ~= nil and B ~= nil and R_Radius ~= nil then
					Binesh.CreateHTMLFile("B = N<span>Mu<sub>0</sub>/2</span> * <span>I/R</span>", "I = <span>2BR/Mu<sub>0</sub>N</span>")
