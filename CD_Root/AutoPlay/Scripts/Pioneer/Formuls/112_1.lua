function Binesh.F112_1()
	...
	if _DeltaRu_Resistor == nil then
		if _Ru_Resistor1 ~= nil and _Ru_Resistor2 ~= nil then
			...
			Binesh.AddToHTML("DeltaRu = "..Binesh.Convert_e(_Ru_Resistor2).."-"..Binesh.Convert_e(_Ru_Resistor1).." &#8658; DeltaRu = "..Binesh.Convert_e(_DeltaRu_Resistor).." Ohm.m")
		end
	end
	...
	if _Ru_Resistor1 == nil then
		if _DeltaRu_Resistor ~= nil and _Ru_Resistor2 ~= nil then
			...
			Binesh.AddToHTML("Ru<sub>1</sub> = "..Binesh.Convert_e(_Ru_Resistor2).."-"..Binesh.Convert_e(_DeltaRu_Resistor).." &#8658; Ru<sub>1</sub> = "..Binesh.Convert_e(_Ru_Resistor1).." Ohm.m")
		end
	end
	...
	if _Ru_Resistor2 == nil then
		if _DeltaRu_Resistor ~= nil and _Ru_Resistor1 ~= nil then
			...
			Binesh.AddToHTML("Ru<sub>2</sub> = "..Binesh.Convert_e(_DeltaRu_Resistor).."+"..Binesh.Convert_e(_Ru_Resistor1).." &#8658; Ru<sub>2</sub> = "..Binesh.Convert_e(_Ru_Resistor2).." Ohm.m")
		end
	end
	--------------------------END {DELTA}--------------------------
	if _DeltaRu_Resistor == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, " €ÌÌ— „ﬁ«Ê„  ÊÌéÂ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "„ﬁ«Ê„  ÊÌéÂ  €ÌÌ—") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "DeltaRu") ~= -1)) then
		if _Ru_Resistor1 ~= nil and Alpha_112 ~= nil and _DeltaTeta ~= nil then
			...
			Binesh.AddToHTML("DeltaRu = "..Binesh.Convert_e(_Ru_Resistor1).."*"..Binesh.Convert_e(Alpha_112).."*"..Binesh.Convert_e(_DeltaTeta).." &#8658; DeltaRu = "..Binesh.Convert_e(_DeltaRu_Resistor).." Ohm.m")
	...
	if _Ru_Resistor1 == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, "«Ê·Ì‰ „ﬁ«Ê„  ÊÌéÂ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "„ﬁ«Ê„  ÊÌéÂ «Ê·Ì‰") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "Ru1") ~= -1)) then
		if _DeltaRu_Resistor ~= nil and Alpha_112 ~= nil and _DeltaTeta ~= nil then
			...
			Binesh.AddToHTML("Ru<sub>1</sub> = <span>"..Binesh.Convert_e(_DeltaRu_Resistor).."/"..Binesh.Convert_e(Alpha_112).."*"..Binesh.Convert_e(_DeltaTeta).."</span> &#8658; Ru<sub>1</sub> = "..Binesh.Convert_e(_Ru_Resistor1).." Ohm.m")
	...
	if Alpha_112 == nil and (ListBox.FindItem("Words", -1, LB_BYTEXT, "÷—Ì» œ„«") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "Alpha") ~= -1) then
		if _DeltaRu_Resistor ~= nil and _Ru_Resistor1 ~= nil and _DeltaTeta ~= nil then
			...
			Binesh.AddToHTML("Alpha = <span>"..Binesh.Convert_e(_DeltaRu_Resistor).."/"..Binesh.Convert_e(_Ru_Resistor1).."*"..Binesh.Convert_e(_DeltaTeta).."</span> &#8658; Alpha = "..Binesh.Convert_e(Alpha_112).." 1/C")
	...
	if _DeltaTeta == nil and ((ListBox.FindItem("Words", -1, LB_BYTEXT, " €ÌÌ— œ„«") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "œ„«  €ÌÌ—") ~= -1) or (ListBox.FindItem("Words", -1, LB_BYTEXT, "DeltaTeta") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "DeltaT") ~= -1)) then
		if _DeltaRu_Resistor ~= nil and Alpha_112 ~= nil and _Ru_Resistor1 ~= nil then
			...
			Binesh.AddToHTML("DeltaTeta = <span>"..Binesh.Convert_e(_DeltaRu_Resistor).."/"..Binesh.Convert_e(Alpha_112).."*"..Binesh.Convert_e(_Ru_Resistor1).."</span> &#8658; DeltaTeta = "..Binesh.Convert_e(_DeltaTeta).."<sup>o</sup>C")
