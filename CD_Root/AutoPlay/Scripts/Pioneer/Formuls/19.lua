...
elseif FindH ~= -1 and ListBox.GetItemData("unknowns", FindH) == "H" and ListBox.FindItem("Words", -1, LB_BYTEXT, "⁄„ﬁ Ê«ﬁ⁄Ì") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "H") ~= -1 then
...
elseif Findn2_Glass ~= -1 and ListBox.GetItemData("unknowns", Findn2_Glass) == "n2" and ListBox.FindItem("Words", -1, LB_BYTEXT, "œÊ„Ì‰ ÷—Ì» ‘ò”  „ÕÌÿ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "n2") ~= -1 then
