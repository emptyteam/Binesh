...
if T_H == nil and T_HC == nil then
	...
	if UnknownNamePersian == -1 and ListBox.GetItemData("unknowns", UnknownNamePersian) ~= 'TH' then
		ListBox.AddItem("unknowns", "ê—„", "TH");
	end
end

FindEtaK = ListBox.FindItem("unknowns", -1, LB_BYTEXT, "»«“œÂ ò«—‰Ê")
FindT_C = ListBox.FindItem("unknowns", -1, LB_BYTEXT, "”—œ");
FindT_H = ListBox.FindItem("unknowns", -1, LB_BYTEXT, "ê—„")
...
elseif FindT_C ~= -1 and ListBox.GetItemData("unknowns", FindT_C) == "TC" and ListBox.FindItem("Words", -1, LB_BYTEXT, "”—œ") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "TC") ~= -1 then
...
elseif FindT_H ~= -1 and ListBox.GetItemData("unknowns", FindT_H) == "TH" and ListBox.FindItem("Words", -1, LB_BYTEXT, "ê—„") ~= -1 or ListBox.FindItem("Words", -1, LB_BYTEXT, "TH") ~= -1 then
