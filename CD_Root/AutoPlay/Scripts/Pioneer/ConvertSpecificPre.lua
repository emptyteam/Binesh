-- ************************ Its just for en symbols. We should create for persian words.

Binesh.ConvertSpecificPre = {}

function Binesh.ConvertSpecificPre.Type1(Variable, Factor, UnitResult) -- This type is for fraction units like: m/s, N/m, g/mol, ...
	-- Reset Variables
	indexText	= nil
	indexPre1	= nil
	indexPre2	= nil
...
function Binesh.ConvertSpecificPre.Type2(Variable, Factor, UnitResult) -- This type is for power units like: m^2, m^3
	-- Reset Variables
	indexText	= nil
	indexPre	= nil
	SymbolPre	= nil
...
function Binesh.ConvertSpecificPre.Type3(Variable, Factor, UnitResult) -- This type is for factor units like: Ohm.m
	-- Reset Variables
	indexText	= nil
	indexPre1	= nil
	indexPre2	= nil
...
function Binesh.ConvertSpecificPre.Type4(Variable, Factor, UnitResult) -- This type is for fraction and factor units like: m/s^2, g/m^3, c/m^2, ...
	-- Reset Variables
	Power1		= nil
	Power2		= nil
	indexText	= nil
...
function Binesh.ConvertSpecificPre.Type5(Variable, Factor, UnitResult) -- This type is for reverse units like: 1/C, 1/K, ...
	-- Reset Variables
	indexText	= nil
	indexPre	= nil
	SymbolPre	= nil
